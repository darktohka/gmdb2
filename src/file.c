...
gmdb_file_init (void) {
	...
	GtkListStore* store;
	int i;
	gchar* ainames[] = { "sql_menu", "debug_menu", "schema_menu", "dump_menu", "info_menu", "close_menu", "sql_button", "schema_button", "dump_button", "info_button", "close_button" };
